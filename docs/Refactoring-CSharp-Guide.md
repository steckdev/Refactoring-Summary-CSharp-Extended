# Refactoring in C#: A Practical Guide (Based on Martin Fowler)
...
Reference the full list in [readme](../readme.md#3-bad-smells-in-code). Below are concise C# illustrations and typical remedies.
